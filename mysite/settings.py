...
SECRET_KEY = 'django-insecure-e1gfz-(g(8b0e244(x3u_-!k0#=6i(#=1xf6y$rii!ea+p77lx'
SECRET_KEY = config('SECRET_KEY', default='django-insecure-e1gfz-(g(8b0e244(x3u_-!k0#=6i(#=1xf6y$rii!ea+p77lx')
